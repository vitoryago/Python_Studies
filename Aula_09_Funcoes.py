...
#AULA 5 - VALORES PADRÕES PARA OS ARGUMENTOS
...
def descobrir_servidor(email):
    try:
        ...
        print('O email digitado não tem @ ou o servidor está incorreto.')
email = input('Qual o seu e-mail? ')
print(descobrir_servidor(email))

#AULA 8 - QUANTIDADE INDEFINIDA DE ARGUMENTOS
...
# print(minha_soma(10,3,41,5,23,10.23))

print(preco_final(1000, desconto = 0.1, imposto = 0.30, garantia_extra = 100))
...
print(len(listar_produtos(estoque_fim_mar)))